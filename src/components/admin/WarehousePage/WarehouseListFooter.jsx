...
function WarheouseListFooter() {
  const warehousePagination = useSelector(
    (states) => states.warehousePagination
  );
  ...
  return (
    <Stack direction="row" alignItems="center">
      ...
      <Pagination
        ...
        count={warehousePagination.totalPage || 1}
        shape="rounded"
        color="primary"
...
export default WarheouseListFooter;
